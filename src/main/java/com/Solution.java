...
//        String expression1 = "e + 8 - a + 5";
//        String[] evalVars1 = {"e"};
//        int[] evalInts1 = {1};

//        String expression1 = "e - 8 + temperature - pressure";
//        String[] evalVars1 = {"e", "temperature"};
//        int[] evalInts1 = {1,12};

        String expression1 = "(e + 8) * (e - 8)";
        String[] evalVars1 = {};
        int[] evalInts1 = {};

//        String expression1 = "a * b * c + b * a * c * 4";
//        String[] evalVars1 = {};
//        int[] evalInts1 = {};

        System.out.println(solution.basicCalculatorIV(expression1,evalVars1,evalInts1));
    }
